...
public class OptionDialogFrame extends JFrame{
    ...
    private Icon messageIcon = new ImageIcon("/Users/lifei/Documents/workspace/learning-area/001Java/CoreJavaVolume1/source/photos/cut.gif");
     ...
     * @return an array of strings, icons, or objects, dependings on the Option panel selection
     */
    public Object[] getOptions(){
        String s = optionsPanel.getSelection();
        if (s.equals("String[]")) return new String[] {"Yellow", "Blue", "Red"};
        else if (s.equals("Icon[]")) return new Icon[] { 
            new ImageIcon("/Users/lifei/Documents/workspace/learning-area/001Java/CoreJavaVolume1/source/photos/copy.gif"),
            new ImageIcon("/Users/lifei/Documents/workspace/learning-area/001Java/CoreJavaVolume1/source/photos/paste.gif")};
        else if (s.equals("Object[]")) return new Object[]{ messageString, messageIcon, messageComponent, messageObject};
        else return null;
    }
    /**
